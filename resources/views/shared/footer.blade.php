        ...
        <div class="row-3 flex">
            ...
            <div class="col-50 flex white-text justify-right">
                <div>
                    ...
                    <!-- FOOTER LINK IMAGES -->
                    <div>
                        <img class="small-image-style" src="https://img.icons8.com/ios-filled/50/twitter-squared.png"
                            alt="twitter-squared" />
                        <svg class="small-image-style" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                            viewBox="0 0 50 50">
                            <path
                                d="M41,4H9C6.24,4,4,6.24,4,9v32c0,2.76,2.24,5,5,5h32c2.76,0,5-2.24,5-5V9C46,6.24,43.76,4,41,4z M37,19h-2c-2.14,0-3,0.5-3,2 v3h5l-1,5h-4v15h-5V29h-4v-5h4v-3c0-4,2-7,6-7c2.9,0,4,1,4,1V19z">
                            </path>
                        </svg>
                        <svg class="small-image-style" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100"
